...
function Datepicker() {
	this._defaults = {
		...
		dateFormat: 'yyyy-mm-dd', // Format for dates  mm/dd/yyyy
	...
	this.regional = {
		'': { // US/English
			...
			prevStatus: '上一个月', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			//prevJumpStatus: 'Show the previous year', // Status text for the previous year command
			prevJumpStatus: '上一年', // Status text for the previous year command
			nextText: '下月', // Text for the next month command
			//nextStatus: 'Show the next month', // Status text for the next month command
			nextStatus: '下一个月', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			//nextJumpStatus: 'Show the next year', // Status text for the next year command
			nextJumpStatus: '下一年', // Status text for the next year command
			//currentText: 'Current', // Text for the current month command
			currentText: '现在', // Text for the current month command
			//currentStatus: 'Show the current month', // Status text for the current month command
			currentStatus: '这个月', // Status text for the current month command
			...
			closeText: '关闭', // Text for the close command
			closeStatus: '关闭', // Status text for the close command
			yearStatus: '变更年份', // Status text for year selection
			monthStatus: '变更月份', // Status text for month selection
