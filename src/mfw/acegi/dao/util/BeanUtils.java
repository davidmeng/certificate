...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
	 ...
	 */
	/*
	 * public static Method getGetterMethod(Class type, String fieldName) { try
	 * { return type.getMethod(getGetterName(type, fieldName)); } catch
	 * (NoSuchMethodException e) { logger.error(e.getMessage(), e); } return
	 * null; }
	 */

	public static void copyBeans(Object target, Object original) {
		try {
			org.apache.commons.beanutils.BeanUtils.copyProperties(target, original);
		} catch (Exception e) {
			logger.error("Error occurred while copy beans", e);
		}
	}
	 ...
	 */
	static public void setPrivateProperty(Object object, String propertyName, Object newValue) throws IllegalAccessException,
